        ...
        <div class="col-md-6 col-lg-5 d-flex align-items-center px-md-4 px-lg-5">
            <div class="w-100">
                ...
                <form action="registrationForm.php" method="post">
                    <div class="mb-3">
                        <input type="text" name='rollNo' class="form-control" id="rollNo" aria-describedby="rollNo" placeholder="Registration Number">
                    ...
                    <div class="mb-3">
                        <input type="password" name='passwordConfirm' class="form-control" id="passwordConfirm" aria-describedby="Confirm password" placeholder="Confirm Password">


                    </div>

                    <button type="submit" name="register" class="btn btn-outline-secondary circle w-100 btn-large shadow-sm">
                ...
                <div class="d-flex justify-content-between mb-3 small">
                    <p>Already have an account?
                        <a class="text-decoration-none" href="./loginForm.php"><small> Log In</small></a>
